...
const WORDS = ["Mahasiswa Teknik Informatika", "Universitas Qomaruddin"];
const TECH_STACK = ["HTML", "CSS", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Faizzz-ezz" },
  { icon: Linkedin, link: "https://www.linkedin.com/" },
  { icon: Instagram, link: "https://www.instagram.com/al_tzyyy_/?next=%2F" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Lebih baik mencoba dan gagal, daripada diam dan nggak melakukan apa-apa.
                </p>
